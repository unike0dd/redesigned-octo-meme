...
const clientLeadContext = body && typeof body.leadContext === "object" ? body.leadContext : {};
const clean = { message: cleanMessage, wikiContext: cleanWiki, lang: cleanLang, sessionId: rawSessionId, page: safeText(body.page || "", 300), leadContext: { source: "gabo_io", origin, intent: safeText(clientLeadContext.intent || "general", 30), score: Number(clientLeadContext.score || 0) || 0, pageTitle: safeText(clientLeadContext.pageTitle || "", 200), referrer: safeText(clientLeadContext.referrer || "", 300) } };
