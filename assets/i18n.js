(function () {
  ...
  const translations = {
    en: {
      ...
      logisticsHowTracking:
        "Data-driven tracking with actionable next steps.",
      whyChooseServiceTitle: "Why Choose This Service",
      logisticsWhyChooseText:
    ...
    es: {
      ...
      whyChooseServiceTitle: "Por qué elegir este servicio",
      logisticsWhyChooseText:
