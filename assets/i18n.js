(function () {
  ...
  const translations = {
    en: {
      ...
      itStatusOwned: "Owned",
      itStatusRouting: "Routing",
      itStatusClear: "Clear",
      itStatusResolution: "Resolution",
      itStatusTracked: "Tracked",
      itSupportLevelsAria: "IT support levels",
      ...
      itLevelOneTag: "Front line",
      itLevelTwoTag: "Deeper review",
    ...
    es: {
      ...
      itStatusRouting: "Enrutamiento",
      itStatusClear: "Claro",
      itStatusResolution: "Resolución",
      itStatusTracked: "Rastreada",
      itSupportLevelsAria: "Niveles de soporte de TI",
      ...
      itLevelOneTag: "Primera línea",
      itLevelTwoTag: "Revisión profunda",
  ...
  Object.assign(translations.en, {
    adminMetaDescription: "Administrative back-office support for workflow coordination, documentation, scheduling, reporting, vendor communication, travel planning, and day-to-day execution.",
    customerMetaDescription: "Customer relations support for communication, ticket follow-up, resolution tracking, CSAT support, billing clarification, upsell support, and first-contact resolution.",
    itMetaDescription: "Structured Level I and Level II IT support for intake, troubleshooting, user support, access assistance, incident investigation, workflow support, and resolution ownership.",
    serviceOverviewAdminDesc: "Workflow coordination, documentation, scheduling, reporting, vendor communication, travel planning, and day-to-day back-office execution.",
    serviceOverviewCustomerDesc: "Customer communication, ticket follow-up, resolution tracking, CSAT support, billing clarification, upsell support, and first-contact resolution.",
    serviceOverviewItDesc: "Structured Level I and Level II support for intake, troubleshooting, user support, access assistance, incident investigation, workflow support, and resolution ownership.",
    homeAdminLane: "Records, scheduling, reporting, and process upkeep.",
    homeCustomerLane: "Communication, follow-up, CSAT, and service rhythm.",
    homeItLane: "Level I and Level II ticket triage and day-to-day request handling.",
    customOptimizationPlanCta: "Get a Custom Optimization Plan",
    requestCustomerSupportCta: "Request customer support",
    requestItSupportCta: "Request IT support",
    viewCoverageCta: "View coverage",
    coverageEyebrow: "Coverage",
    serviceLanesEyebrow: "Service handling",
    workflowEyebrow: "Workflow",
    dynamicFocusEyebrow: "Dynamic Focus",
    outcomeEyebrow: "Outcome",
    laneActionSupport: "Support",
    laneActionAlign: "Align",
    laneActionManage: "Manage",
    laneActionPrepare: "Prepare",
    laneActionCoordinate: "Coordinate",
    laneActionExecute: "Execute",
    laneActionTrack: "Track",
    laneActionResolve: "Resolve",
    laneActionRecover: "Recover",
    laneActionClarify: "Clarify",
    laneActionClose: "Close",
    adminCoverageTitle: "Administrative Back Office Support",
    adminLanesTitle: "Administrative support lanes",
    adminLane1Title: "Executive Administrative Support",
    adminLane2Title: "Calendar and Scheduling Coordination",
    adminLane3Title: "Email and Communication Management",
    adminLane4Title: "Documentation and Reporting",
    adminLane5Title: "Vendor and Internal Coordination",
    adminLane6Title: "Travel Planning and Day-to-Day Execution",
    adminStatusReporting: "Reporting",
    adminStatusClear: "Clear",
    adminWorkflowAria: "Administrative workflow steps",
    adminProcessStep1: "Receive",
    adminProcessStep2: "Clarify",
    adminProcessStep3: "Organize",
    adminProcessStep4: "Coordinate",
    adminProcessStep5: "Report",
    adminProcessStep6: "Close",
    adminFocusTabRecords: "Records and Documentation",
    adminFocusTabScheduling: "Scheduling and Coordination",
    adminFocusTabVendorTravel: "Vendor and Travel Support",
    serviceFocusAdminRecordsTitle: "Records and Documentation",
    serviceFocusAdminRecordsText: "Keep documents, records, reports, and internal references clean, prepared, and easier to retrieve.",
    serviceFocusAdminSchedulingTitle: "Scheduling and Coordination",
    serviceFocusAdminSchedulingText: "Align calendars, deadlines, follow-ups, and internal handoffs so daily work keeps moving.",
    serviceFocusAdminSchedulingItem1: "Calendar alignment",
    serviceFocusAdminSchedulingItem2: "Deadline tracking",
    serviceFocusAdminSchedulingItem3: "Follow-up reminders",
    serviceFocusAdminSchedulingItem4: "Internal coordination",
    serviceFocusAdminVendorTravelTitle: "Vendor and Travel Support",
    serviceFocusAdminVendorTravelText: "Coordinate vendor communication, travel details, status updates, and day-to-day administrative execution.",
    serviceFocusAdminVendorTravelItem1: "Vendor communication",
    serviceFocusAdminVendorTravelItem2: "Travel planning",
    serviceFocusAdminVendorTravelItem3: "Status updates",
    serviceFocusAdminVendorTravelItem4: "Daily execution",
    customerSnapshotTitle: "Better follow-through creates stronger trust.",
    customerStatusCommunication: "Communication",
    customerStatusManaged: "Managed",
    customerStatusResolution: "Resolution",
    customerStatusSupported: "Supported",
    customerStatusEscalation: "Escalation",
    customerCoverageTitle: "Customer Relations Support",
    customerLanesTitle: "Customer relations handling lanes",
    customerLane1Title: "Customer Communication Management",
    customerLane2Title: "Ticket Follow-up and Resolution Tracking",
    customerLane3Title: "First-Contact Resolution Support",
    customerLane4Title: "CSAT and Service Recovery",
    customerLane5Title: "Billing and Upsell Support",
    customerLane6Title: "Escalation Visibility and Case Closure",
    customerWorkflowAria: "Customer relations workflow steps",
    customerProcessStep1: "Receive",
    customerProcessStep2: "Clarify",
    customerProcessStep3: "Update",
    customerProcessStep4: "Track",
    customerProcessStep5: "Recover",
    customerProcessStep6: "Close",
    customerFocusTabCommunication: "Communication",
    customerFocusTabResolution: "Resolution Flow",
    customerFocusTabSatisfaction: "Satisfaction Continuity",
    customerFocusTabBillingUpsell: "Billing and Upsell",
    customerFocusTabEscalationClosure: "Escalation Closure",
    serviceFocusCustomerCommunicationTitle: "Communication",
    serviceFocusCustomerCommunicationText: "Keep every customer touchpoint clear, timely, and documented so trust is easier to protect.",
    serviceFocusCustomerResolutionTitle: "Resolution Flow",
    serviceFocusCustomerResolutionText: "Maintain visibility from ticket follow-up through ownership, recovery action, and final case closure.",
    serviceFocusCustomerSatisfactionTitle: "Satisfaction Continuity",
    serviceFocusCustomerSatisfactionText: "Support CSAT follow-ups, feedback notes, service recovery moments, and customer trust checks.",
    serviceFocusCustomerSatisfactionItem1: "CSAT support",
    serviceFocusCustomerSatisfactionItem2: "Satisfaction follow-ups",
    serviceFocusCustomerSatisfactionItem3: "Feedback notes",
    serviceFocusCustomerSatisfactionItem4: "Customer trust checks",
    serviceFocusCustomerBillingUpsellTitle: "Billing and Upsell",
    serviceFocusCustomerBillingUpsellText: "Clarify billing questions while keeping appropriate upsell opportunities visible and service-led.",
    serviceFocusCustomerBillingUpsellItem1: "Billing clarification",
    serviceFocusCustomerBillingUpsellItem2: "Customer context notes",
    serviceFocusCustomerBillingUpsellItem3: "Upsell opportunity support",
    serviceFocusCustomerBillingUpsellItem4: "Follow-through routing",
    serviceFocusCustomerEscalationClosureTitle: "Escalation Closure",
    serviceFocusCustomerEscalationClosureText: "Keep escalations visible, routed, documented, and closed with clear resolution notes.",
    serviceFocusCustomerEscalationClosureItem1: "Escalation visibility",
    serviceFocusCustomerEscalationClosureItem2: "Concern routing",
    serviceFocusCustomerEscalationClosureItem3: "Case notes",
    serviceFocusCustomerEscalationClosureItem4: "Resolution closure",
    itDetailTitle: "IT Support",
    itDetailHeroCopy: "Structured Level I and Level II technical support coverage for help desk intake, ticket creation, troubleshooting, end-user support, access assistance, incident investigation, workflow support, root-cause analysis, escalation coordination, and resolution ownership.",
    itProofPill1: "Intake structured",
    itProofPill2: "Triage prioritized",
    itProofPill3: "Escalation owned",
    itSnapshotEyebrow: "IT Snapshot",
    itSnapshotTitle: "Clear intake. Strong triage. Accountable resolution.",
    itStatusTriage: "Triage",
    itStatusPrioritized: "Prioritized",
    itStatusSupport: "Support",
    itStatusResponsive: "Responsive",
    itWorkflowAria: "IT support workflow steps",
    itProcessStep1: "Receive",
    itProcessStep2: "Classify",
    itProcessStep3: "Resolve at Level I",
    itProcessStep4: "Escalate to Level II",
    itProcessStep5: "Analyze Root Cause",
    itProcessStep6: "Close with Clarity",
    itFocusTabLevelOne: "Level I Support",
    itFocusTabLevelTwo: "Level II Support",
    itFocusTabEscalation: "Escalation Flow",
    itLeadBandEyebrow: "Reliable Support Coverage",
    serviceFocusItLevelOneTitle: "Level I Support",
    serviceFocusItLevelTwoTitle: "Level II Support",
    serviceFocusItEscalationFlowTitle: "Escalation Flow",
    serviceFocusItEscalationFlowText: "Keep escalations documented, prioritized, handed off cleanly, and owned through final closure.",
    serviceFocusItEscalationFlowItem1: "Escalation coordination",
    serviceFocusItEscalationFlowItem2: "Issue notes",
    serviceFocusItEscalationFlowItem3: "Priority tracking",
    serviceFocusItEscalationFlowItem4: "Status communication",
    serviceFocusItEscalationFlowItem5: "Resolution closure",
  });

  Object.assign(translations.es, {
    adminMetaDescription: "Soporte administrativo de back office para coordinación de flujos, documentación, programación, reportes, comunicación con proveedores, planificación de viajes y ejecución diaria.",
    customerMetaDescription: "Soporte de relaciones con clientes para comunicación, seguimiento de tickets, control de resolución, soporte CSAT, aclaración de facturación, upsell y resolución de primer contacto.",
    itMetaDescription: "Soporte de TI estructurado Nivel I y Nivel II para recepción, diagnóstico, soporte a usuarios, asistencia de acceso, investigación de incidentes, soporte de flujos y propiedad de resolución.",
    serviceOverviewAdminDesc: "Coordinación de flujos, documentación, programación, reportes, comunicación con proveedores, planificación de viajes y ejecución diaria de back office.",
    serviceOverviewCustomerDesc: "Comunicación con clientes, seguimiento de tickets, control de resolución, soporte CSAT, aclaración de facturación, soporte de upsell y resolución de primer contacto.",
    serviceOverviewItDesc: "Soporte Nivel I y Nivel II estructurado para recepción, diagnóstico, soporte a usuarios, asistencia de acceso, investigación de incidentes, soporte de flujos y propiedad de resolución.",
    homeAdminLane: "Registros, programación, reportes y mantenimiento de procesos.",
    homeCustomerLane: "Comunicación, seguimiento, CSAT y ritmo de servicio.",
    homeItLane: "Triaje de tickets Nivel I y Nivel II y gestión diaria de solicitudes.",
    customOptimizationPlanCta: "Obtener un plan de optimización personalizado",
    requestCustomerSupportCta: "Solicitar soporte al cliente",
    requestItSupportCta: "Solicitar soporte de TI",
    viewCoverageCta: "Ver cobertura",
    coverageEyebrow: "Cobertura",
    serviceLanesEyebrow: "Gestión del servicio",
    workflowEyebrow: "Flujo de trabajo",
    dynamicFocusEyebrow: "Enfoque dinámico",
    outcomeEyebrow: "Resultado",
    laneActionSupport: "Apoyar",
    laneActionAlign: "Alinear",
    laneActionManage: "Gestionar",
    laneActionPrepare: "Preparar",
    laneActionCoordinate: "Coordinar",
    laneActionExecute: "Ejecutar",
    laneActionTrack: "Controlar",
    laneActionResolve: "Resolver",
    laneActionRecover: "Recuperar",
    laneActionClarify: "Aclarar",
    laneActionClose: "Cerrar",
    adminCoverageTitle: "Soporte Administrativo de Back Office",
    adminLanesTitle: "Líneas de soporte administrativo",
    adminLane1Title: "Soporte Administrativo Ejecutivo",
    adminLane2Title: "Coordinación de Calendario y Programación",
    adminLane3Title: "Gestión de Correo y Comunicación",
    adminLane4Title: "Documentación y Reportes",
    adminLane5Title: "Coordinación con Proveedores e Interna",
    adminLane6Title: "Planificación de Viajes y Ejecución Diaria",
    adminStatusReporting: "Reportes",
    adminStatusClear: "Claros",
    adminWorkflowAria: "Pasos del flujo administrativo",
    adminProcessStep1: "Recibir",
    adminProcessStep2: "Aclarar",
    adminProcessStep3: "Organizar",
    adminProcessStep4: "Coordinar",
    adminProcessStep5: "Reportar",
    adminProcessStep6: "Cerrar",
    adminFocusTabRecords: "Registros y Documentación",
    adminFocusTabScheduling: "Programación y Coordinación",
    adminFocusTabVendorTravel: "Soporte de Proveedores y Viajes",
    serviceFocusAdminRecordsTitle: "Registros y Documentación",
    serviceFocusAdminRecordsText: "Mantén documentos, registros, reportes y referencias internas limpios, preparados y fáciles de recuperar.",
    serviceFocusAdminSchedulingTitle: "Programación y Coordinación",
    serviceFocusAdminSchedulingText: "Alinea calendarios, fechas límite, seguimientos y traspasos internos para que el trabajo diario avance.",
    serviceFocusAdminSchedulingItem1: "Alineación de calendario",
    serviceFocusAdminSchedulingItem2: "Control de fechas límite",
    serviceFocusAdminSchedulingItem3: "Recordatorios de seguimiento",
    serviceFocusAdminSchedulingItem4: "Coordinación interna",
    serviceFocusAdminVendorTravelTitle: "Soporte de Proveedores y Viajes",
    serviceFocusAdminVendorTravelText: "Coordina comunicación con proveedores, detalles de viaje, actualizaciones de estado y ejecución administrativa diaria.",
    serviceFocusAdminVendorTravelItem1: "Comunicación con proveedores",
    serviceFocusAdminVendorTravelItem2: "Planificación de viajes",
    serviceFocusAdminVendorTravelItem3: "Actualizaciones de estado",
    serviceFocusAdminVendorTravelItem4: "Ejecución diaria",
    customerSnapshotTitle: "Un mejor seguimiento crea más confianza.",
    customerStatusCommunication: "Comunicación",
    customerStatusManaged: "Gestionada",
    customerStatusResolution: "Resolución",
    customerStatusSupported: "Soportado",
    customerStatusEscalation: "Escalación",
    customerCoverageTitle: "Soporte de Relaciones con Clientes",
    customerLanesTitle: "Líneas de gestión de relaciones con clientes",
    customerLane1Title: "Gestión de Comunicación con Clientes",
    customerLane2Title: "Seguimiento de Tickets y Control de Resolución",
    customerLane3Title: "Soporte de Resolución de Primer Contacto",
    customerLane4Title: "CSAT y Recuperación de Servicio",
    customerLane5Title: "Soporte de Facturación y Upsell",
    customerLane6Title: "Visibilidad de Escalación y Cierre de Casos",
    customerWorkflowAria: "Pasos del flujo de relaciones con clientes",
    customerProcessStep1: "Recibir",
    customerProcessStep2: "Aclarar",
    customerProcessStep3: "Actualizar",
    customerProcessStep4: "Controlar",
    customerProcessStep5: "Recuperar",
    customerProcessStep6: "Cerrar",
    customerFocusTabCommunication: "Comunicación",
    customerFocusTabResolution: "Flujo de Resolución",
    customerFocusTabSatisfaction: "Continuidad de Satisfacción",
    customerFocusTabBillingUpsell: "Facturación y Upsell",
    customerFocusTabEscalationClosure: "Cierre de Escalaciones",
    serviceFocusCustomerCommunicationTitle: "Comunicación",
    serviceFocusCustomerCommunicationText: "Mantén cada contacto con clientes claro, oportuno y documentado para proteger la confianza.",
    serviceFocusCustomerResolutionTitle: "Flujo de Resolución",
    serviceFocusCustomerResolutionText: "Mantén visibilidad desde el seguimiento de tickets hasta la propiedad, recuperación y cierre final.",
    serviceFocusCustomerSatisfactionTitle: "Continuidad de Satisfacción",
    serviceFocusCustomerSatisfactionText: "Apoya seguimientos CSAT, notas de retroalimentación, recuperación de servicio y revisiones de confianza.",
    serviceFocusCustomerSatisfactionItem1: "Soporte CSAT",
    serviceFocusCustomerSatisfactionItem2: "Seguimientos de satisfacción",
    serviceFocusCustomerSatisfactionItem3: "Notas de retroalimentación",
    serviceFocusCustomerSatisfactionItem4: "Revisiones de confianza",
    serviceFocusCustomerBillingUpsellTitle: "Facturación y Upsell",
    serviceFocusCustomerBillingUpsellText: "Aclara preguntas de facturación mientras mantiene visibles oportunidades adecuadas de upsell orientadas al servicio.",
    serviceFocusCustomerBillingUpsellItem1: "Aclaración de facturación",
    serviceFocusCustomerBillingUpsellItem2: "Notas de contexto del cliente",
    serviceFocusCustomerBillingUpsellItem3: "Soporte de oportunidades de upsell",
    serviceFocusCustomerBillingUpsellItem4: "Enrutamiento de seguimiento",
    serviceFocusCustomerEscalationClosureTitle: "Cierre de Escalaciones",
    serviceFocusCustomerEscalationClosureText: "Mantén escalaciones visibles, enrutadas, documentadas y cerradas con notas claras de resolución.",
    serviceFocusCustomerEscalationClosureItem1: "Visibilidad de escalación",
    serviceFocusCustomerEscalationClosureItem2: "Enrutamiento de inquietudes",
    serviceFocusCustomerEscalationClosureItem3: "Notas de caso",
    serviceFocusCustomerEscalationClosureItem4: "Cierre de resolución",
    itDetailTitle: "Soporte de TI",
    itDetailHeroCopy: "Cobertura técnica estructurada Nivel I y Nivel II para recepción de mesa de ayuda, creación de tickets, diagnóstico, soporte a usuarios finales, asistencia de acceso, investigación de incidentes, soporte de flujos, análisis de causa raíz, coordinación de escalaciones y propiedad de resolución.",
    itProofPill1: "Recepción estructurada",
    itProofPill2: "Triaje priorizado",
    itProofPill3: "Escalación con propietario",
    itSnapshotEyebrow: "Resumen de TI",
    itSnapshotTitle: "Recepción clara. Triaje sólido. Resolución responsable.",
    itStatusTriage: "Triaje",
    itStatusPrioritized: "Priorizado",
    itStatusSupport: "Soporte",
    itStatusResponsive: "Responsivo",
    itWorkflowAria: "Pasos del flujo de soporte de TI",
    itProcessStep1: "Recibir",
    itProcessStep2: "Clasificar",
    itProcessStep3: "Resolver en Nivel I",
    itProcessStep4: "Escalar a Nivel II",
    itProcessStep5: "Analizar Causa Raíz",
    itProcessStep6: "Cerrar con Claridad",
    itFocusTabLevelOne: "Soporte Nivel I",
    itFocusTabLevelTwo: "Soporte Nivel II",
    itFocusTabEscalation: "Flujo de Escalación",
    itLeadBandEyebrow: "Cobertura de Soporte Confiable",
    serviceFocusItLevelOneTitle: "Soporte Nivel I",
    serviceFocusItLevelTwoTitle: "Soporte Nivel II",
    serviceFocusItEscalationFlowTitle: "Flujo de Escalación",
    serviceFocusItEscalationFlowText: "Mantén escalaciones documentadas, priorizadas, traspasadas con claridad y con propietario hasta el cierre final.",
    serviceFocusItEscalationFlowItem1: "Coordinación de escalación",
    serviceFocusItEscalationFlowItem2: "Notas del incidente",
    serviceFocusItEscalationFlowItem3: "Control de prioridad",
    serviceFocusItEscalationFlowItem4: "Comunicación de estado",
    serviceFocusItEscalationFlowItem5: "Cierre de resolución",
  });
  ...
  Object.assign(translations.en, {
    ...
    aboutApproachTitle: "Consistency, clarity, and practical execution.",
    aboutApproachText: "We integrate with your operating rhythm, protect follow-through, and communicate status in a clear and dependable way.",
    aboutUnresolvedEyebrow: "When Opportunities Are Left Unresolved",
    aboutUnresolvedTitle: "Small delays become operational drag.",
    aboutUnresolvedText: "Missed follow-ups, unclear ownership, fragmented notes, and slow responses can affect customer trust, leadership focus, and team momentum.",
    aboutBeforeEyebrow: "Before",
    aboutBeforeTitle: "Unresolved work piles up.",
    aboutBeforeItem1: "Tasks move without clear owners.",
    aboutBeforeItem2: "Customers wait for updates.",
    aboutBeforeItem3: "Leaders chase routine details.",
    aboutAfterEyebrow: "After",
    aboutAfterTitle: "Daily work has rhythm.",
    aboutAfterItem1: "Follow-up is tracked.",
    aboutAfterItem2: "Status is visible.",
    aboutAfterItem3: "Teams regain focus for growth.",
    aboutHandleEyebrow: "What We Handle",
    aboutHandleTitle: "Cross-functional operational coverage.",
    aboutHandleLogisticsTitle: "Logistics Operations",
    aboutHandleLogisticsText: "Dispatch coordination, tracking, carrier follow-up, documentation, and exception visibility.",
    aboutHandleAdminTitle: "Administrative Back Office",
    aboutHandleAdminText: "Scheduling, email coordination, vendor support, reporting, travel planning, and documentation.",
    aboutHandleCustomerTitle: "Customer Relations",
    aboutHandleCustomerText: "Customer communication, ticket follow-up, satisfaction support, billing clarification, and case closure.",
    aboutHandleItTitle: "IT Support",
    aboutHandleItText: "Help desk intake, troubleshooting, access assistance, incident investigation, and escalation ownership.",
    aboutValueEyebrow: "How We Create Value",
    aboutValueTitle: "We convert operational gaps into repeatable support rhythm.",
    aboutValueAssessTitle: "Assess",
    aboutValueAssessText: "Clarify workflows and support gaps.",
    aboutValueIntegrateTitle: "Integrate",
    aboutValueIntegrateText: "Align with tools and communication style.",
    aboutValueExecuteTitle: "Execute",
    aboutValueExecuteText: "Move daily work with follow-through.",
    aboutValueMonitorTitle: "Monitor",
    aboutValueMonitorText: "Keep status and exceptions visible.",
    aboutValueOptimizeTitle: "Optimize",
    aboutValueOptimizeText: "Refine rhythm as needs evolve.",
    aboutResultEyebrow: "The Result",
    aboutResultTitle: "A cleaner operational rhythm with clearer ownership, faster follow-through, stronger communication, and more time for your team to focus on growth.",
    aboutResultPrimaryCta: "Start a conversation",
    aboutResultSecondaryCta: "Review services",
    ...
    logisticsPrimaryCta: "Get a Custom Optimization Plan",
    logisticsSnapshotEyebrow: "Service Snapshot",
    logisticsSnapshotTitle: "Logistics snapshot for coordinated movement",
    logisticsSnapshotAssessment: "Assessment",
    logisticsSnapshotClear: "Clear",
    logisticsSnapshotExecution: "Execution",
    logisticsSnapshotConsistent: "Consistent",
    logisticsSnapshotMonitoring: "Monitoring",
    logisticsSnapshotOngoing: "Ongoing",
    logisticsVisibilityEyebrow: "Logistics Snapshot",
    logisticsVisibilityTitle: "Practical operational visibility across the movement lifecycle.",
    logisticsVisibilityText: "We support the daily communication and tracking details that protect timelines and reduce avoidable surprises.",
    logisticsOfferEyebrow: "What We Offer",
    logisticsOfferTitle: "Focused daily execution support.",
    logisticsOffer1: "Dispatch coordination and communication",
    logisticsOffer2: "Shipment tracking for ocean, air, and ground transport",
    logisticsOffer3: "Freight quote support and documentation coordination",
    logisticsOffer4: "Customer communication and follow-ups",
    logisticsOffer5: "Supplier and carrier follow-up",
    logisticsOffer6: "Inventory status monitoring",
    logisticsOffer7: "Exception management and delay visibility",
    logisticsOffer8: "Invoicing and billing support",
    logisticsOffer9: "Delivery timeline protection",
    logisticsOffer10: "Operational status updates",
    logisticsHandlingEyebrow: "Service Handling",
    logisticsHandlingTitle: "Clear ownership for moving work forward.",
    logisticsLaneDispatchTitle: "Dispatch and communication",
    logisticsLaneDispatchText: "Coordinate dispatch details and keep stakeholders informed.",
    logisticsLaneTrackingTitle: "Tracking and visibility",
    logisticsLaneTrackingText: "Monitor ocean, air, and ground shipment status with practical updates.",
    logisticsLaneDocsTitle: "Documentation and billing",
    logisticsLaneDocsText: "Support quotes, documents, invoicing, and billing coordination.",
    logisticsLaneExceptionsTitle: "Exception management",
    logisticsLaneExceptionsText: "Surface delays, supplier gaps, carrier updates, and timeline risks.",
    logisticsPlanSupportCta: "Plan support",
    logisticsWorkflowEyebrow: "Workflow",
    logisticsWorkflowTitle: "How support moves from assessment to optimization.",
    logisticsWorkflowIntro: "We use a practical operating rhythm that keeps work coordinated, status visible, and next steps actionable.",
    logisticsWorkflowAssessmentTitle: "Assessment",
    logisticsWorkflowAssessmentText: "Map support needs, friction points, and priorities.",
    logisticsWorkflowIntegrationTitle: "Integration",
    logisticsWorkflowIntegrationText: "Align with workflows, systems, and communication standards.",
    logisticsWorkflowExecutionTitle: "Execution",
    logisticsWorkflowExecutionText: "Handle day-to-day work with dependable follow-through.",
    logisticsWorkflowMonitoringTitle: "Monitoring",
    logisticsWorkflowMonitoringText: "Track activity, open items, and operational visibility.",
    logisticsWorkflowOptimizationTitle: "Optimization",
    logisticsWorkflowOptimizationText: "Refine support rhythm and reduce repeat friction.",
    logisticsTransformationEyebrow: "Operational Transformation",
    logisticsTransformationTitle: "From reactive work to visible support rhythm.",
    logisticsBeforeEyebrow: "Before",
    logisticsBeforeTitle: "Status gets fragmented.",
    logisticsBeforeText: "Updates, delays, documents, and follow-ups are scattered across handoffs.",
    logisticsAfterEyebrow: "After",
    logisticsAfterTitle: "Movement becomes visible.",
    logisticsAfterText: "Open items, exceptions, and delivery timelines are tracked with clearer communication.",
    logisticsDynamicFocusEyebrow: "Dynamic Focus",
    logisticsDynamicFocusTitle: "Choose the support priority that needs movement.",
    logisticsDynamicFocusAria: "Dynamic service focus",
    logisticsFocusCoordinateTab: "Coordinate",
    logisticsFocusCoordinateTitle: "Coordinate dispatch, supplier, and carrier follow-up.",
    logisticsFocusCoordinateText: "Keep daily communication moving with clear ownership and next steps.",
    logisticsFocusCoordinateItems: "Dispatch coordination|Supplier and carrier follow-up|Customer communication and follow-ups",
    logisticsFocusTrackTab: "Track",
    logisticsFocusTrackTitle: "Track shipments and inventory status.",
    logisticsFocusTrackText: "Maintain visibility for ocean, air, and ground transport with practical status updates.",
    logisticsFocusTrackItems: "Shipment tracking|Inventory status monitoring|Delivery timeline protection",
    logisticsFocusResolveTab: "Resolve",
    logisticsFocusResolveTitle: "Manage exceptions and documentation gaps.",
    logisticsFocusResolveText: "Surface delays, billing questions, and documentation needs before they stall work.",
    logisticsFocusResolveItems: "Exception management and delay visibility|Freight quote support|Invoicing and billing support",
    logisticsOutcomeEyebrow: "Outcome CTA",
    logisticsOutcomeTitle: "More visible logistics activity, clearer follow-up, stronger documentation, and dependable support for dispatch, tracking, billing, and operational updates.",
  });
  ...
  Object.assign(translations.es, {
    ...
    aboutApproachTitle: "Consistencia, claridad y ejecución práctica.",
    aboutApproachText: "Nos integramos a tu ritmo operativo, protegemos el seguimiento y comunicamos el estado de forma clara y confiable.",
    aboutUnresolvedEyebrow: "Cuando las oportunidades quedan sin resolver",
    aboutUnresolvedTitle: "Los pequeños retrasos se convierten en carga operativa.",
    aboutUnresolvedText: "Seguimientos perdidos, propietarios poco claros, notas fragmentadas y respuestas lentas pueden afectar la confianza del cliente, el enfoque del liderazgo y el impulso del equipo.",
    aboutBeforeEyebrow: "Antes",
    aboutBeforeTitle: "El trabajo sin resolver se acumula.",
    aboutBeforeItem1: "Las tareas avanzan sin propietarios claros.",
    aboutBeforeItem2: "Los clientes esperan actualizaciones.",
    aboutBeforeItem3: "Los líderes persiguen detalles rutinarios.",
    aboutAfterEyebrow: "Después",
    aboutAfterTitle: "El trabajo diario tiene ritmo.",
    aboutAfterItem1: "El seguimiento queda registrado.",
    aboutAfterItem2: "El estado es visible.",
    aboutAfterItem3: "Los equipos recuperan enfoque para crecer.",
    aboutHandleEyebrow: "Lo que gestionamos",
    aboutHandleTitle: "Cobertura operativa multifuncional.",
    aboutHandleLogisticsTitle: "Operaciones Logísticas",
    aboutHandleLogisticsText: "Coordinación de despacho, seguimiento, contacto con transportistas, documentación y visibilidad de excepciones.",
    aboutHandleAdminTitle: "Back Office Administrativo",
    aboutHandleAdminText: "Programación, coordinación de correo, soporte a proveedores, reportes, planificación de viajes y documentación.",
    aboutHandleCustomerTitle: "Relaciones con Clientes",
    aboutHandleCustomerText: "Comunicación con clientes, seguimiento de tickets, apoyo a satisfacción, aclaración de facturación y cierre de casos.",
    aboutHandleItTitle: "Soporte de TI",
    aboutHandleItText: "Recepción de mesa de ayuda, solución de problemas, asistencia de acceso, investigación de incidentes y propiedad de escalaciones.",
    aboutValueEyebrow: "Cómo creamos valor",
    aboutValueTitle: "Convertimos brechas operativas en un ritmo de soporte repetible.",
    aboutValueAssessTitle: "Evaluar",
    aboutValueAssessText: "Aclarar flujos de trabajo y brechas de soporte.",
    aboutValueIntegrateTitle: "Integrar",
    aboutValueIntegrateText: "Alinear con herramientas y estilo de comunicación.",
    aboutValueExecuteTitle: "Ejecutar",
    aboutValueExecuteText: "Mover el trabajo diario con seguimiento.",
    aboutValueMonitorTitle: "Monitorear",
    aboutValueMonitorText: "Mantener visibles el estado y las excepciones.",
    aboutValueOptimizeTitle: "Optimizar",
    aboutValueOptimizeText: "Refinar el ritmo a medida que evolucionan las necesidades.",
    aboutResultEyebrow: "El resultado",
    aboutResultTitle: "Un ritmo operativo más limpio, con propiedad más clara, seguimiento más rápido, comunicación más sólida y más tiempo para que tu equipo se enfoque en crecer.",
    aboutResultPrimaryCta: "Iniciar una conversación",
    aboutResultSecondaryCta: "Revisar servicios",
    ...
    logisticsPrimaryCta: "Obtener un plan de optimización personalizado",
    logisticsSnapshotEyebrow: "Resumen del Servicio",
    logisticsSnapshotTitle: "Resumen logístico para movimiento coordinado",
    logisticsSnapshotAssessment: "Evaluación",
    logisticsSnapshotClear: "Claro",
    logisticsSnapshotExecution: "Ejecución",
    logisticsSnapshotConsistent: "Consistente",
    logisticsSnapshotMonitoring: "Monitoreo",
    logisticsSnapshotOngoing: "Continuo",
    logisticsVisibilityEyebrow: "Resumen Logístico",
    logisticsVisibilityTitle: "Visibilidad operativa práctica en todo el ciclo de movimiento.",
    logisticsVisibilityText: "Apoyamos los detalles diarios de comunicación y seguimiento que protegen los tiempos y reducen sorpresas evitables.",
    logisticsOfferEyebrow: "Lo que ofrecemos",
    logisticsOfferTitle: "Soporte enfocado para la ejecución diaria.",
    logisticsOffer1: "Coordinación de despacho y comunicación",
    logisticsOffer2: "Seguimiento de envíos marítimos, aéreos y terrestres",
    logisticsOffer3: "Soporte de cotizaciones de carga y coordinación documental",
    logisticsOffer4: "Comunicación y seguimiento con clientes",
    logisticsOffer5: "Seguimiento a proveedores y transportistas",
    logisticsOffer6: "Monitoreo del estado de inventario",
    logisticsOffer7: "Gestión de excepciones y visibilidad de retrasos",
    logisticsOffer8: "Soporte de facturación y cobros",
    logisticsOffer9: "Protección de tiempos de entrega",
    logisticsOffer10: "Actualizaciones de estado operativo",
    logisticsHandlingEyebrow: "Gestión del Servicio",
    logisticsHandlingTitle: "Propiedad clara para mover el trabajo hacia adelante.",
    logisticsLaneDispatchTitle: "Despacho y comunicación",
    logisticsLaneDispatchText: "Coordinar detalles de despacho y mantener informadas a las partes interesadas.",
    logisticsLaneTrackingTitle: "Seguimiento y visibilidad",
    logisticsLaneTrackingText: "Monitorear el estado de envíos marítimos, aéreos y terrestres con actualizaciones prácticas.",
    logisticsLaneDocsTitle: "Documentación y facturación",
    logisticsLaneDocsText: "Apoyar cotizaciones, documentos, facturas y coordinación de cobros.",
    logisticsLaneExceptionsTitle: "Gestión de excepciones",
    logisticsLaneExceptionsText: "Exponer retrasos, brechas con proveedores, actualizaciones de transportistas y riesgos de tiempo.",
    logisticsPlanSupportCta: "Planificar soporte",
    logisticsWorkflowEyebrow: "Flujo de Trabajo",
    logisticsWorkflowTitle: "Cómo el soporte avanza desde la evaluación hasta la optimización.",
    logisticsWorkflowIntro: "Usamos un ritmo operativo práctico que mantiene el trabajo coordinado, el estado visible y los próximos pasos accionables.",
    logisticsWorkflowAssessmentTitle: "Evaluación",
    logisticsWorkflowAssessmentText: "Mapear necesidades de soporte, puntos de fricción y prioridades.",
    logisticsWorkflowIntegrationTitle: "Integración",
    logisticsWorkflowIntegrationText: "Alinear con flujos de trabajo, sistemas y estándares de comunicación.",
    logisticsWorkflowExecutionTitle: "Ejecución",
    logisticsWorkflowExecutionText: "Gestionar el trabajo diario con seguimiento confiable.",
    logisticsWorkflowMonitoringTitle: "Monitoreo",
    logisticsWorkflowMonitoringText: "Rastrear actividad, elementos abiertos y visibilidad operativa.",
    logisticsWorkflowOptimizationTitle: "Optimización",
    logisticsWorkflowOptimizationText: "Refinar el ritmo de soporte y reducir fricción repetida.",
    logisticsTransformationEyebrow: "Transformación Operativa",
    logisticsTransformationTitle: "Del trabajo reactivo a un ritmo de soporte visible.",
    logisticsBeforeEyebrow: "Antes",
    logisticsBeforeTitle: "El estado se fragmenta.",
    logisticsBeforeText: "Actualizaciones, retrasos, documentos y seguimientos quedan dispersos entre traspasos.",
    logisticsAfterEyebrow: "Después",
    logisticsAfterTitle: "El movimiento se vuelve visible.",
    logisticsAfterText: "Elementos abiertos, excepciones y tiempos de entrega se rastrean con comunicación más clara.",
    logisticsDynamicFocusEyebrow: "Enfoque Dinámico",
    logisticsDynamicFocusTitle: "Elige la prioridad de soporte que necesita movimiento.",
    logisticsDynamicFocusAria: "Enfoque dinámico del servicio",
    logisticsFocusCoordinateTab: "Coordinar",
    logisticsFocusCoordinateTitle: "Coordinar despacho, proveedores y seguimiento con transportistas.",
    logisticsFocusCoordinateText: "Mantén la comunicación diaria en movimiento con propiedad clara y próximos pasos.",
    logisticsFocusCoordinateItems: "Coordinación de despacho|Seguimiento a proveedores y transportistas|Comunicación y seguimiento con clientes",
    logisticsFocusTrackTab: "Rastrear",
    logisticsFocusTrackTitle: "Rastrear envíos y estado de inventario.",
    logisticsFocusTrackText: "Mantén visibilidad de transporte marítimo, aéreo y terrestre con actualizaciones prácticas de estado.",
    logisticsFocusTrackItems: "Seguimiento de envíos|Monitoreo del estado de inventario|Protección de tiempos de entrega",
    logisticsFocusResolveTab: "Resolver",
    logisticsFocusResolveTitle: "Gestionar excepciones y brechas documentales.",
    logisticsFocusResolveText: "Expón retrasos, preguntas de facturación y necesidades documentales antes de que detengan el trabajo.",
    logisticsFocusResolveItems: "Gestión de excepciones y visibilidad de retrasos|Soporte de cotizaciones de carga|Soporte de facturación y cobros",
    logisticsOutcomeEyebrow: "CTA de Resultado",
    logisticsOutcomeTitle: "Actividad logística más visible, seguimiento más claro, documentación más sólida y soporte confiable para despacho, rastreo, facturación y actualizaciones operativas.",
  });
  ...
  const I18N = {
    ...
    applyLanguage() {
      ...
      // Apply to data-i18n-focus-* for dynamic focus button payload attributes
      document.querySelectorAll("[data-i18n-focus-title]").forEach((el) => {
        const key = el.getAttribute("data-i18n-focus-title");
        el.setAttribute("data-focus-title", this.t(key));
      });

      document.querySelectorAll("[data-i18n-focus-text]").forEach((el) => {
        const key = el.getAttribute("data-i18n-focus-text");
        el.setAttribute("data-focus-text", this.t(key));
      });

      document.querySelectorAll("[data-i18n-focus-items]").forEach((el) => {
        const key = el.getAttribute("data-i18n-focus-items");
        el.setAttribute("data-focus-items", this.t(key));
      });
      ...
      document.querySelectorAll("[data-dynamic-focus]").forEach((board) => {
        const activeTab =
          board.querySelector(".focus-tab[aria-selected='true']") ||
          board.querySelector(".focus-tab");
        activeTab?.click();
      });
